function [succ_meas_diff_set, kine_meas_diff_set] = test_policy_vs_succRate_interaction_fcn(score_succ_by_trial_grp, score_fail_by_trial_grp)
...
for i_grp = 1:4
    ...
    kin_frac(i_grp, 1:size(kine_meas{1, i_grp},2)) = nanmean((kine_meas{2, i_grp})-nanmean(kine_meas{1, i_grp}))./nanmean(kine_meas{1, i_grp});
    catch
        warning('wttttf')
    end
end
